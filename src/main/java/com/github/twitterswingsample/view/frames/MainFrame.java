...
public class MainFrame extends JFrame {
    ...
    private final JMenu switchUser, removeUser;
    ...
    public MainFrame() {
        ...
        try {
            ...
            ConsolePanel.getInstance().printMessage(
                    new String[] { "Look-And-Feel could not be set", e1.getLocalizedMessage() });
        }
        ...
        try {
            ...
            ConsolePanel.getInstance().printMessage(
                    new String[] { "SQL Exception thrown, there is an incorrect SQL statement",
                            "Please report that bug!", e.getLocalizedMessage() });
        } catch (ClassNotFoundException e) {
            ConsolePanel.getInstance().printMessage(
                    new String[] { "SQLite driver couldn't be found", "Please report that bug!",
